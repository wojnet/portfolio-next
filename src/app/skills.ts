...
const skills: ISkill[] = [
    ...
    { url: "/svg/nextjs-original.svg", stars: 4, alt: "Next.js", title: "Next.js", description: "Next.js is **`React framework`** that enables server-side rendering and other powerful features for web applications." },
    ...
    { url: "/svg/typescript-plain.svg", stars: 3, alt: "TypeScript", title: "TypeScript", description: "It&apos;s a **`JavaScript superset`** that makes workflow much better. I have basic experience with TypeScript." },
    ...
    { url: "/svg/csharp-plain.svg", stars: 2, alt: "ASP.NET Core", title: "ASP.NET Core", description: "**ASP.NET Core** is a framework for building web applications and APIs using the **.NET platform**." },
